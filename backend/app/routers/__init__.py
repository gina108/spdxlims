...
from app.routers import auth, billing, instruments, inventory, lab_profile, month_close, operations, orders, outsourced, panels, patients, providers, reports, results, statistics, stock, tests
